...
min(disp_beforeFilterDisp001, [], 'all')
max(disp_beforeFilterDisp001, [], 'all')
...
disp_afterFilterDisp001_synthesis = depth_beforeFilterDisp001_rescale - 0.3 .* disp_afterFilterDisp001_rescale;
